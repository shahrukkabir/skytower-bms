...
export default function WeProvide() {
  return (
    <div className="w-full min-h-screen overflow-hidden flex justify-center flex-col items-center bg-no-repeat bg-cover bg-center bg-fixed p-2 md:p-5 xl:p-10 py-10 relative"
      style={{
