    ...
    return (
        <div className="w-full min-h-screen flex flex-col items-center justify-center p-5 md:p-10 bg-white">
            ...
            <div className="w-full flex flex-col justify-center items-center">
                ...
                <h1 className="text-3xl md:text-5xl text-center mt-8 mb-8 font-bold text-[#312720]">
                    What Makes A Home?
                </h1>
                <p className="max-w-[750px] mx-auto mb-8 text-center text-[#5a4b43]">
                ...
                {stats.map((stat, i) => {
                    ...
                    return (
                        <div key={i} ref={ref} className="w-full">
                            <div className="w-full h-[50px]" style={{ background: `linear-gradient(${angle}, ${color} 0%, ${color} 50%, rgba(255,0,0,0) 50%, rgba(255,0,0,0) 100%)`}}></div>
                            {/* Content */}
